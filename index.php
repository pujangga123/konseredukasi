...
<body>
    ...
    <main id="main">
        ...
        <section id="profil" class="text-center" >
            <div class="section-title" onclick="window.open('profile-billy-kristanto.php')" style="cursor:pointer">
                <h2>Profil</h2>
                <img src="assets/img/garis.png">
            </div>
            <div class="container">
        ...
        <section id="lokasi" class="lokasi">
            ...
            <div class="text-center">
                <iframe
                    height="300"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.532243141504!2d107.6065826102288!3d-6.946366293024828!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e9f82b8afbd3%3A0xcbb37327fd0cb875!2sIndonesian%20Reformed%20Evangelical%20Church%20-%20Bandung!5e0!3m2!1sen!2sid!4v1722092892802!5m2!1sen!2sid"
                    style="border:0; width:80%" allowfullscreen="" loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade"></iframe>
                <img src="assets/img/gedung1.jpg" alt="Aula Stefanus, GRII Bandung" style="max-width:40%">
                <img src="assets/img/gedung2.jpg" alt="Aula Stefanus, GRII Bandung" style="max-width:40%">
            </div>
                ...
                <div class="row">
                    <div class="col text-center">
                        <div style="background-color:#c5aa76; width:60px; border-radius:50%; padding:10px; margin:auto;">
                            <i class='bx bxs-map-pin' style="font-size:2.5em; color:black"></i>
                        </div>
                        <h4 class="mt-2">Alamat</h4>
                        <div>Jl. Moh. Toha 229</div>
                    </div>
                    <div class="col text-center">
                        <div style="background-color:#c5aa76; width:60px; border-radius:50%; padding:10px; margin:auto;">
                    ...
                    <div class="col text-center">
                        <div style="background-color:#c5aa76; width:60px; border-radius:50%; padding:10px; margin:auto;">
                            <i class='bx bx-envelope' style="font-size:2.5em; color:black"></i>
                        </div>
                        <h4 class="mt-2">E-mail</h4>
                        <div><a href="mailto:griibdg@gmail.com">griibdg@gmail.com</a></div>
                    </div>
                </div>
            </div>
