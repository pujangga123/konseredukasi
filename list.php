        ...
        <tbody>
            <?php foreach($arr as $key=>$row) { ?> 
                <tr>
                    ...
                    <?php if($editmode) { ?>
                        <td><a href="https://wa.me/<?php echo $row['telp']; ?>?text=Pendaftaran+Konser+Edukasi%0D%0A<?php echo $row['nama']; ?>%0D%0ANomor:*<?php echo $key; ?>*%0D%0A%0D%0A">WhatsApp</a> - <a href="hapus.php?num=<?php echo $key; ?>" onclick="return confirm('Hapus?')">Hapus</a></td>
                    <?php } else { ?>
